   ...
   <footer className="main-footer">
                    ...
                    <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
                        <div className="info-inner">
                            <div className="content">
                                ...
                                <div className="text">Email us : <br></br> <a href="mailto:devatakeoff@gmail.com">contact@takeoff.com</a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
                        <div className="info-inner">
                            <div className="content">
                                ...
                                <div className="text">Call us on : <br></br><strong>+ 2519 897 3654</strong></div>
                            </div>
                        </div>
                    </div>
        ...
        <div className="auto-container">
            <div className="footer-bottom">
                <div className="copyright-text">© Copyright  <a href="#">Takeoff</a> 2026 . All right reserved.</div>
                <div className="text">Created by <a href="#">Dawit Birhanu</a></div>
            </div>
        </div>
    </footer>
    </div>
